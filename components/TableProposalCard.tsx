          ...
          <div className="flex items-start justify-between gap-2">
            ...
            {booking && (
              <button
                ...
                className="shrink-0 rounded-lg border border-white/25 bg-black/50 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-white"
              >
                Close
              </button>
            )}
          ...
          <div className="mt-3 border border-line/60 bg-ink/50 p-3">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <button
                ...
                className="rounded-lg bg-ivory px-5 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-ink disabled:opacity-40"
              >
                Continue
              </button>
              <button
                type="button"
                onClick={cancelBookingFlow}
                className="rounded-lg border border-line px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-muted"
              >
                Cancel
              </button>
            </div>
          ...
          <div className="mt-3 border border-line/60 bg-ink/50 p-3">
            ...
            <div className="mt-3 flex flex-col gap-2">
              <button
                ...
                className="w-full rounded-lg bg-white py-3 text-[13px] font-semibold text-black disabled:opacity-40"
              >
              ...
              <button
                ...
                className="w-full rounded-lg border border-white/25 py-2.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-ivory disabled:opacity-40"
              >
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {!iAgreed && (
              <button
                type="button"
                onClick={onAgree}
                className="rounded-lg bg-ivory px-5 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-ink"
              >
                I agree
              </button>
            )}
