        ...
        <div className="pointer-events-none fixed inset-x-0 top-[max(0.75rem,env(safe-area-inset-top))] z-[80] flex justify-center px-3 pt-2 sm:top-20 sm:pt-3">
          <div className="mp-modal-in pointer-events-auto w-full max-w-md border border-accent/40 bg-[#1c1c1e] p-4 shadow-[0_16px_48px_rgba(0,0,0,0.65)]">
            ...
            <button
              type="button"
              onClick={onExpand}
              className="mp-btn-lux mt-4 w-full rounded-lg bg-ivory py-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-ink hover:brightness-110"
            >
              See table ideas
            </button>
          </div>
                ...
                >
                  ...
                  <div className="px-3 py-2.5">
                    ...
                    <button
                      ...
                      className="mt-2.5 w-full rounded-lg bg-ivory py-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-ink"
                    >
                      Propose table
                    </button>
                  </div>
