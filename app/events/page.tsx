        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="rounded-sm border border-accent/30 px-3.5 py-1.5 text-[11px] font-medium text-accent transition hover:border-accent/55 hover:bg-accent/10"
            >
            ...
            <button
              ...
              className="rounded-sm border border-line px-3.5 py-1.5 text-[11px] font-medium text-muted transition hover:border-accent/40 hover:text-ivory"
            >
              Around the world
            </button>
            <button
