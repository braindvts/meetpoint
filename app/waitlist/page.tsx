...
export const metadata: Metadata = {
  ...
  description: `Request access to ${BRAND} — the private network for ambitious people.`,
};
...
export default function WaitlistPage() {
  return (
    <main className="mp-site">
      ...
      <section className="relative flex min-h-[calc(100dvh-4.5rem)] flex-col justify-center px-6 pb-20 pt-24">
      ...
      <footer className="border-t border-white/[0.06] px-6 py-8 text-center text-[12px] text-muted">
