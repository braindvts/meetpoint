    ...
    <main className="mp-site overflow-x-hidden">
      <header className="fixed inset-x-0 top-0 z-30 border-b border-white/[0.06] bg-ink/70 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <Magnetic>
            <Link href="/waitlist" className="il-btn il-landing-cta il-landing-cta--fill !min-w-0 px-4 py-2 text-[12px]">
              Request access
            </Link>
          </Magnetic>
        </div>
      ...
      <section className="relative isolate min-h-[calc(100dvh-4.5rem)] px-6 pb-16 pt-24 md:pt-28">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          <div>
            ...
            <div className="mp-reveal mp-reveal-delay-3 mt-10 w-full max-w-md">
              <WaitlistForm compact id="hero-waitlist" />
            </div>
            <div className="mp-reveal mp-reveal-delay-3 mt-4 flex flex-wrap items-center gap-x-4 gap-y-2">
              <Link href="/login" className="text-[13px] text-muted transition hover:text-ivory">
                Already a member? Sign in
              </Link>
              <Link href="/waitlist" className="text-[13px] text-accent transition hover:text-ivory">
                Add your name
              </Link>
            </div>
            {demoEntryEnabled() && (
      ...
      <section className="relative border-t border-white/[0.06] px-6 py-24">
        <Reveal className="mx-auto max-w-md text-center">
          <p className="il-kicker">Private access</p>
          <h2 className="mt-3 font-display text-3xl font-semibold tracking-[-0.03em] text-ivory sm:text-4xl">
            Request a seat
          </h2>
          ...
          <Link href="/waitlist" className="mt-4 inline-block text-[13px] text-accent hover:text-ivory">
            Add your name
          </Link>
        </Reveal>
      </section>
