  ...
  return (
    <main className="mp-app relative flex min-h-dvh flex-col items-center justify-center overflow-hidden px-8 text-center">
      <div
        ...
        aria-hidden
      />
      <h1 className="mp-reveal relative font-display text-[2.75rem] font-semibold leading-[1.05] tracking-[0.14em] text-accent sm:text-5xl">
        CONCLAVE
      </h1>
      <p className="mp-reveal mp-reveal-delay-2 relative mt-5 max-w-xs font-display text-lg italic leading-snug text-ivory/85">
