...
/** Extra intents that are not LookingFor chips but show up in bios and events. */
export const SOFT_INTENTS: Record<string, string[]> = {
  career: [
    "career",
    "careers",
    "job search",
  ...
  intros: ["intro", "intros", "introduction", "introductions", "warm intro"],
};
